...
<body>
    ...
    <div id="divId3">
        <form action="dbcon.php" method="POST">
            ...
            <input type="checkbox" id="sinhala" name="subjects[]" value="Sinhala"><br>
            <label for="english" class="subjects">English</label>
            <input type="checkbox" id="english" name="subjects[]" value="English"><br>
            <label for="maths" class="subjects">Mathematics</label>
            <input type="checkbox" id="maths" name="subjects[]" value="Mathematics"><br>
            <label for="science" class="subjects">Science</label>
            <input type="checkbox" id="science" name="subjects[]" value="Science"><br>
            <label for="commerce" class="subjects">Accounting and Business Studeis</label>
            <input type="checkbox" id="commerce" name="subjects[]" value="Accounting and Business Studeis"><br>
            <label for="ict" class="subjects">Information Communication Technology</label>
            <input type="checkbox" id="ict" name="subjects[]" value="Information Communication Technology"><br>
            ...
            <input type="submit" value="submit" class="submit" class="submit" name="submit"><br>
        </form>
    </div>
